                ...
                <div className="card">
                  ...
                  <div className="card-body d-flex flex-column">
                    <div>
                      ...
                      <br />
                      <i className="fa fa-map-marker fa-fw" aria-hidden="true" />&nbsp; <span>{this.props.modalContent.location}</span>
                    </div>
                    ...
                    <button
                      ...
                      data-dismiss="modal"> Book now for ₦{this.props.modalContent.price}/Day
                    </button>
                  </div>
                </div>
              </div>
